import { z } from 'zod';
import { TaskTypeClassificationDtoSchema } from '@/api/old-zod-schemas/TaskTypeClassificationDtoSchema_';
import { CycleSubspanGroupSnapshotDtoSchema } from '@/api/old-zod-schemas/CycleSubspanGroupSnapshotDtoSchema';
