...
export interface GenericTableRecord<Row, Column, CellContent, RowId, ColumnId, CellId, CellReference> {
    rowList: Row[];
    columnList: Column[];
    rowColumnCellReferenceMap: { [index: string]: { [index: string]: CellReference } };
...
export interface Bundle<T> extends KnowledgeTreeNode, NodeWithChildren<KnowledgeDomainGroup<T>> {
...
export interface DeliveryAllocationList extends KnowledgeTreeNode, NodeWithChildren<DeliveryAllocationLeaf> {
...
export interface KnowledgeDomainGroup<T> extends KnowledgeTreeNode, NodeWithChildren<T> {
    knowledgeDomains: KnowledgeDomainDto[];
    children: T[];
}

export interface KnowledgeLevelGroup<T> extends KnowledgeTreeNode, NodeWithChildren<Bundle<T>> {
    knowledgeLevel: KnowledgeLevelDto;
    children: Bundle<T>[];
}

export interface KnowledgeLevelSeriesGroup<T> extends KnowledgeTreeNode, NodeWithChildren<KnowledgeLevelGroup<T>> {
...
export interface OrganizationLeafCycleSubspanGroupFeasibilityDto extends Serializable {
...
export interface OrganizationLeafTotalAllocationFeasibilityDto extends Serializable {
    organizationId: number;
    cycleId: number;
...
export interface WorkSchemaNodeLeafDto extends Serializable, DtoWrapper<WorkSchemaNodeLeaf, WorkSchemaNodeLeafDto, number> {
    id: number;
...
export interface WorkSchemaNodeRootTotalDeliveryAllocationRollupDto extends Serializable {
    id: number;
    name: string;
...
export interface CarouselGroupDto extends Serializable, DtoWrapper<any, CarouselGroupDto, number>, CollectionDto<CarouselGroupOptionDto, number> {
    id: number;
    name: string;
...
export interface ColorDto extends Serializable, DtoWrapper<any, ColorDto, number> {
    id: number;
    r: number;
    g: number;
    b: number;
...
export interface CycleDto extends Serializable, DtoWrapper<any, CycleDto, number> {
    id: number;
...
export interface CycleSubspanGroupDto extends Serializable, DtoWrapper<any, CycleSubspanGroupDto, number>, CollectionDto<CycleSubspanJoinDto, number> {
    cycleSubspanJoins: CycleSubspanJoinDto[];
    id: number;
}

export interface InteractionBasedValidationDto extends ValidationTypeDto, Serializable, DtoWrapper<any, InteractionBasedValidationDto, number> {
}

export interface KnowledgeDomainDto extends Serializable, DtoWrapper<any, KnowledgeDomainDto, number> {
    id: number;
    name: string;
    shortCode?: string;
    color?: ColorDto;
...
export interface KnowledgeLevelSeriesDto extends Serializable, DtoWrapper<any, KnowledgeLevelSeriesDto, number> {
    id: number;
    name: string;
...
export interface TimeDivisionDto extends Serializable, DtoWrapper<any, TimeDivisionDto, number> {
    id: number;
...
export interface AssetDto extends Serializable, DtoWrapper<any, AssetDto, number> {
    id: number;
    name: string;
    ownerId?: number;
    type: AssetTypeDto;
...
export interface AssetRoleDto extends Serializable, DtoWrapper<any, AssetRoleDto, number> {
    assetId: number;
...
export interface BuildMetricDto extends Serializable, DtoWrapper<any, BuildMetricDto, number> {
    id: number;
    finalState: string;
...
export interface CarouselDto extends Serializable, CollectionDto<CarouselOptionDto, number>, DtoWrapper<any, CarouselDto, number> {
    id: number;
    name: string;
...
export interface CarouselOrderDto extends Serializable, DtoWrapper<any, CarouselOrderDto, string>, CollectionDto<CarouselOrderItemDto, number> {
    id: string;
...
export interface DeliveryAllocationDto extends Serializable, DtoWrapper<any, DeliveryAllocationDto, number> {
    id: number;
...
export interface KnowledgeLevelDto extends Serializable, DtoWrapper<any, KnowledgeLevelDto, number> {
    name: string;
    id: number;
    levelOrdinal: number;
...
export interface OrganizationDto extends Serializable, DtoWrapper<any, OrganizationDto, number> {
    id: number;
    name: string;
...
export interface WorkProjectSeriesSchemaDto extends Serializable, DtoWrapper<any, WorkProjectSeriesSchemaDto, number>, CollectionDto<DeliveryAllocationDto, number> {
    id: number;
    name: string;
...
export interface AssetRoleAvailabilityDto extends Serializable, DtoWrapper<any, AssetRoleAvailabilityDto, number>, IntersectionDto<number, number>, RoleAvailabilityDto {
    assetRoleId: number;
    assetId: number;
}

export interface AssetRoleTypeWorkTaskTypeSuitabilityDto extends Serializable, DtoWrapper<any, AssetRoleTypeWorkTaskTypeSuitabilityDto, number>, TriIntersectionDto<number, number, number> {
    id: number;
    rating: number;
...
export interface CarouselOptionDto extends Serializable, IntersectionDto<number, number>, DtoWrapper<any, CarouselOptionDto, number> {
    carouselId: number;
    id: number;
    workProjectSeriesSchemaId: number;
}

export interface CarouselOrderItemDto extends Serializable, DtoWrapper<any, CarouselOrderItemDto, number>, IntersectionDto<string, number> {
    id: number;
...
export interface CycleSubspanDto extends Serializable, DtoWrapper<any, CycleSubspanDto, number> {
    id: number;
...
export interface CycleSubspanJoinDto extends Serializable, DtoWrapper<any, CycleSubspanJoinDto, number>, IntersectionDto<number, number> {
    id: number;
    cycleSubspanGroupId: number;
    cycleSubspanGroupSize: number;
    joinOrdinal: number;
...
export interface ProviderRoleAvailabilityDto extends Serializable, DtoWrapper<any, ProviderRoleAvailabilityDto, number>, IntersectionDto<number, number>, RoleAvailabilityDto {
    providerRoleId: number;
    partyId: number;
}

export interface ProviderRoleDto extends DtoWrapper<any, ProviderRoleDto, number> {
    name: string;
    id: number;
    partyName: string;
    partyId: number;
...
export interface ProviderRoleTypeWorkTaskTypeSuitabilityDto extends Serializable, DtoWrapper<any, ProviderRoleTypeWorkTaskTypeSuitabilityDto, number>, TriIntersectionDto<number, number, number> {
    id: number;
    rating: number;
    partyId: number;
...
export interface UserRoleDto extends Serializable, DtoWrapper<any, UserRoleDto, number> {
    id: number;
    name: string;
...
export interface WorkSchemaNodeAssignmentDto extends Serializable, DtoWrapper<any, WorkSchemaNodeAssignmentDto, number>, IntersectionDto<number, number> {
    id: number;
    organizationId: number;
    workSchemaNodeId?: number;
}

export interface WorkSchemaNodeDto extends Serializable, DtoWrapper<any, WorkSchemaNodeDto, number> {
    allowBundle: boolean;
...
export interface AssetRoleTypeDto extends Serializable, TypeDto<any, AssetRoleTypeDto> {
}
...
export interface OrganizationTypeDto extends Serializable, TypeDto<any, OrganizationTypeDto> {
}

export interface PartyNodeRelationshipTypeDto extends Serializable, TypeDto<any, PartyNodeRelationshipTypeDto> {
    hierarchical: boolean;
}

export interface ProviderRoleTypeDto extends Serializable, TypeDto<any, ProviderRoleTypeDto> {
}

export interface UserRoleTypeDto extends Serializable, TypeDto<any, UserRoleTypeDto> {
}

export interface WorkTaskTypeDto extends Serializable, TypeDto<any, WorkTaskTypeDto> {
...
export interface WorkProjectSeriesAssignmentDto extends Serializable, DtoWrapper<any, WorkProjectSeriesAssignmentDto, number> {
    id: number;
    sourceNodeId: number;
...
export interface WorkProjectSeriesDto extends Serializable, DtoWrapper<any, WorkProjectSeriesDto, string> {
    id: string;
    scheduleId: number;
...
export interface PersonDto extends Serializable, DtoWrapper<any, PersonDto, number> {
    id: number;
...
export interface ScheduleDto extends Serializable, DtoWrapper<any, ScheduleDto, number> {
    id: number;
...
export interface StaticDeliveryAllocationItemDto extends Serializable, DtoWrapper<any, StaticDeliveryAllocationItemDto, number> {
    id: number;
    cycleSubspanGroupId: number;
...
export interface WorkProjectSeriesEnrollmentDto extends Serializable, DtoWrapper<any, WorkProjectSeriesEnrollmentDto, number> {
    id: number;
    userRoleId: number;
...
export interface WorkProjectSeriesMetricDto extends DtoWrapper<any, WorkProjectSeriesMetricDto, number> {
    id: number;
