/* tslint:disable */
/* eslint-disable */
// Generated using typescript-generator version 3.2.1263 on 2024-10-04 13:14:06.
...
export interface TestPersonClass extends Serializable {
    id: number;
    dateOfBirth: DateAsString;
    fName: string;
    lName: string;
...
export interface TestPersonRecord extends Serializable {
    id: number;
    dateOfBirth: DateAsString;
    fName: string;
    lName: string;
