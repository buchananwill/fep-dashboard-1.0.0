...
export const allProviders = [
  {
    ...
    availabilities: [
      replaceDayStartEnd('TUESDAY', '10:00:00', '12:00:00'),
      replaceDayStartEnd('THURSDAY', '10:00:00', '12:00:00')
    ]
  },
  {
    baseEntity: names[1],
    suitabilities: [replaceKnowledgeDomainInclusions(['Piano'])],
    availabilities: [replaceDayStartEnd('WEDNESDAY', '17:00:00', '20:00:00')]
  },
  {
    baseEntity: names[2],
    suitabilities: [replaceKnowledgeDomainInclusions(['Classical Voice'])],
    availabilities: [
      replaceDayStartEnd('TUESDAY', '10:00:00', '16:00:00'),
      replaceDayStartEnd('THURSDAY', '14:00', '20:00:00')
    ]
  },
  {
    baseEntity: names[3],
    ...
    availabilities: [
      replaceDayStartEnd('TUESDAY', '9:00', '17:00:00'),
      replaceDayStartEnd('MONDAY', '12:00:00', '17:00:00'),
      replaceDayStartEnd('WEDNESDAY', '12:00:00', '17:00:00'),
      replaceDayStartEnd('THURSDAY', '12:00:00', '17:00:00')
    ]
  },
  {
    baseEntity: names[4],
    ...
    availabilities: [
      replaceDayStartEnd('WEDNESDAY', '10:00:00', '20:00:00'),
      replaceDayStartEnd('THURSDAY', '10:00:00', '20:00:00')
    ]
  },
  {
    baseEntity: names[5],
    ...
    availabilities: [
      replaceDayStartEnd('MONDAY', '14:15:00', '15:15:00'),
      replaceDayStartEnd('THURSDAY', '10:00:00', '12:00:00')
    ]
  },
  {
    ...
    availabilities: [replaceDayStartEnd('WEDNESDAY', '11:00:00', '13:00:00')]
  },
  {
    baseEntity: names[7],
  ...
  },
  {
    ...
    availabilities: [
      replaceDayStartEnd('WEDNESDAY', '11:00:00', '12:00:00'),
      replaceDayStartEnd('FRIDAY', '11:00:00', '12:00:00')
    ]
  },
  {
    baseEntity: names[0],
